...
function AddTodo({ addTodo }) {
    ...
    const handleAdd = (e)=>{
        e?.preventDefault();
        if (text.trim() === "") {
            __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$sonner$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].info("请输入待办事项后再提交。");
            return;
        }
        addTodo(text);
        setText("");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__045b5a49._.js.map